        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Registre venda, endereço, pagamento e valor.
            </p>
          </div>
        ...
        <form onSubmit={salvarEntrega} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full border rounded-xl p-3"
            >
              <option value="Botijão 13kg">Botijão 13kg</option>
              <option value="Botijão 20kg">Botijão 20kg</option>
              <option value="Botijão 45kg">Botijão 45kg</option>
            </select>
          </div>
